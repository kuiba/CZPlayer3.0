...
{
	QMenu menu;
	menu.addAction(QIcon(":/app/images/addMusic.png"), tr("添加歌曲"), m_parent, SLOT(slot_OpenFile()));			//添加歌曲
	menu.addAction(QIcon(":/app/images/folder.png"), tr("添加歌曲文件夹"), m_parent, SLOT(slot_AddMusicDir()));		//添加歌曲文件夹
	menu.addAction(QIcon(":/app/images/addMusicList.png"), tr("载入播放列表"), m_parent, SLOT(slot_AddMusicList()));//添加歌曲
