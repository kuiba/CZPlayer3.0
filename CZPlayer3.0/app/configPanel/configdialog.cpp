...
void ConfigDialog::generalSettingAppFunc()
{
	...
	if (GeneralSettingsPage::getDefaultPlayer() == Qt::Checked)
	{
		...
		FileRelation::registerFileRelation(_T(".mp3"), filePath, _T("CZPlayer3.0.MP3"), icoPath, _T("MP3文件"));
		FileRelation::registerFileRelation(_T(".wma"), filePath, _T("CZPlayer3.0.WMA"), icoPath, _T("WMA文件"));
		FileRelation::registerFileRelation(_T(".wav"), filePath, _T("CZPlayer3.0.WAV"), icoPath, _T("WAV文件"));
		FileRelation::registerFileRelation(_T(".ogg"), filePath, _T("CZPlayer3.0.OGG"), icoPath, _T("OGG文件"));
	}
	else
	{
